...
from cwtvlad.utils.data.sampler import DistributedSliceSampler
...
from cwtvlad.utils.serialization import load_checkpoint, save_checkpoint, copy_state_dict, write_json
from cwtvlad.utils.dist_utils import init_dist, synchronize
...
def get_model(args):
    ...
    if args.vlad:
        pool_layer = models.create('cwtvlad', dim=base_model.feature_dim)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="CWTVLAD testing")
