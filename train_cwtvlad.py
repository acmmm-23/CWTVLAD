...
from cwtvlad import datasets
from cwtvlad import models
from cwtvlad.trainers import CWTVLADTrainer
from cwtvlad.evaluators import Evaluator, extract_features, pairwise_distance
from cwtvlad.utils.data import IterLoader, get_transformer_train, get_transformer_test
from cwtvlad.utils.data.sampler import DistributedRandomDiffTupleSampler, DistributedSliceSampler
from cwtvlad.utils.data.preprocessor import Preprocessor
from cwtvlad.utils.logging import Logger
from cwtvlad.pca import PCA
from cwtvlad.utils.serialization import load_checkpoint, save_checkpoint, copy_state_dict
from cwtvlad.utils.dist_utils import init_dist, synchronize, convert_sync_bn
from cwtvlad.utils.rerank import re_ranking
...
def get_model(args):
    ...
    pool_layer = models.create('cwtvlad', dim=base_model.feature_dim, num_clusters=args.num_clusters)
...
def main_worker(args):
    ...
    # Trainer
    trainer = CWTVLADTrainer(model, model_cache, margin=args.margin**0.5,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="CWTVLAD training")
